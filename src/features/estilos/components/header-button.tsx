  ...
  return (
    <StyledWrapper>
      ...
      >
        ...
        {leaves.map((leaf) => (
          <LeafIcon key={leaf.className} leaf={leaf} />
        ))}
      </a>
    </StyledWrapper>
  );
...
const StyledWrapper = styled.span`
  ...
  .button {
    ...
    min-width: 8.65rem;
    padding: 13px 35px;
    background: rgb(144 96 48 / 90%);
    color: var(--ipp-white);
    border: none;
    border-radius: 8px;
    box-shadow: 2px 2px 5px #18181869;
  ...
  .button-active {
    ...
    box-shadow:
      ...
      0 0 0 2px rgb(123 155 58 / 32%);
  }

  .button:hover,
  .button:focus-visible {
    background: var(--ipp-earth);
    padding: 13px 25px;
  ...
  @media (prefers-reduced-motion: reduce) {
    ...
    .button:hover .leaf-icon,
    .button:focus-visible .leaf-icon {
      animation: none;
    }
  }
`;
